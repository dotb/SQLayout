#
#  Be sure to run `pod spec lint SQLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SQLayout"
  s.version      = "1.1.0"
  s.summary      = "Simple layout tools for UIViews that need to be placed relative to one another."
...
#                   DESC
  ...
  # s.exclude_files = "SQLayout/Exclude"

  # s.public_header_files = "SQLayout/**/*.h"
